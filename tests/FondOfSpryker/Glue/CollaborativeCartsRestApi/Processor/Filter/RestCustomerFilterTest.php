...
namespace FondOfSpryker\Glue\CollaborativeCartsRestApi\Processor\Filter;
...
class RestCustomerFilterTest extends Unit
{
    ...
    /**
     * @var \FondOfSpryker\Glue\CollaborativeCartsRestApi\Processor\Filter\RestCustomerFilter
     */
